...
function () {
  function Game(element, width, height) {
    ...
    this.boardGap = 10; // instantiate the players
    ...
    this.player2 = new _Paddle__WEBPACK_IMPORTED_MODULE_2__["default"](this.height, this.paddleWidth, this.paddleHeight, this.width - this.paddleWidth - this.boardGap, (this.height - this.paddleHeight) / 2, _settings__WEBPACK_IMPORTED_MODULE_0__["KEYS"].up, _settings__WEBPACK_IMPORTED_MODULE_0__["KEYS"].down); // set properties for the ball

    this.radius = 8; // instantiate the Ball

    this.ball = new _Ball__WEBPACK_IMPORTED_MODULE_3__["default"](this.radius, this.width, this.height); // instantiate the Score

    this.score1 = new _Score__WEBPACK_IMPORTED_MODULE_4__["default"](this.width / 2 - 22, 20, 30);
    this.score2 = new _Score__WEBPACK_IMPORTED_MODULE_4__["default"](this.width / 2 + 10, 20, 30); // add a function for pausing the game
